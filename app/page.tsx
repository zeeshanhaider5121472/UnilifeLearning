    ...
    <div className="min-h-screen animated-bg relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button
              ...
              className="px-6 py-2 rounded-xl bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-semibold hover:shadow-lg hover:shadow-violet-500/25 transition-all duration-300 dark:shadow-none shadow-md"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Sign In
      ...
      <div className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <motion.div
                className="inline-block px-4 py-1.5 rounded-full glass text-sm text-violet-600 dark:text-violet-300 mb-6"
              ...
              <p className="text-lg text-slate-600 dark:text-gray-400 max-w-lg mb-8">
      ...
      <div className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.p
            className="text-slate-600 dark:text-gray-400 text-center mb-16 text-lg"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
      ...
      <footer className="py-10 px-6 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto text-center text-slate-500 dark:text-gray-500 text-sm">
